...
urlpatterns = [
    ...
    path('<slug:community_slug>/verify-join/', views.verify_follow, name='join-verify'),
    path('<slug:community_slug>/verify-unjoin/', views.verify_unfollow, name='unjoin-verify'),
